...
if(isset($_POST['first'])) {
    ...
    if ($id_exist == true) {
        ...
        if (empty($errors) == true) {
           ...
           $result = mysql_query("insert into basic values('','$basicCourse','$course_duration','$dateOfExamination','$centreName',
                    '$traineeName','$fatherName','$motherName','$idNo','$registrationNo','$passportNo','$traineeAddress',
    ...
    $drawingJob = $_POST['drawingJob'];
	 ...
	 $speedJob = $_POST['speedJob'];
	 $eSafetyJob= $_POST['eSafetyJob'];
    $eaverageJob1 = $_POST['eaverageJob1'];
   ...
   $refer_exist = refer_exist($regerenceNoJob);
    if ($refer_exist == true) {
            ...
            if (empty($errors) == true) {
                ...
                '$drawingJob','$speedJob','$safetyJob','$eaverageJob','$ecommentsJob'
                );") or die(mysql_error());
            } else {
                echo '<script>alert("' . $errors[0] . '\n' . $errors[1] . '\n")</script>';
...
<?php include 'header.php';?>
		...
		<section id="resultSubmit">
			<div class="container">
				<div id="tabs">
					<ul>
						<li><a href="#tabs-1">Job Test Certificate</a></li>
						<li><a href="#tabs-2">Basic Certificate</a></li>
					</ul>
					<div id="tabs-1">
						<form action="" method="post" enctype="multipart/form-data">
							<fieldset>
								...
								<div class="row">
									...
									<div class="form-group col-md-4">
										...
										<input type="text" class="form-control datepicker" name="dateOfExaminationJob" id="dateOfExaminationJob" placeholder="DD/MM/YYYY">
									</div>
							...
							<fieldset>
								...
								<div class="row">
									<div class="form-group col-md-12">
										<label for="traineeAddressJob">Refer From</label>
										<input type="text" class="form-control" name="traineeAddressJob" id="traineeAddressJob" placeholder="Refer From">
									</div>
								</div>
							</fieldset>
							...
							<fieldset>
								...
								<div class="row">
									<div class="form-group col-md-4">
										<label for="eExamNoJob">Exam No</label>
										<label for="eSafetyJob">Safety Job</label>
									...
									<div class="form-group col-md-2">
										...
										<input type="text" class="form-control resultjob" name="eSafetyJob" id="eSafetyJob" placeholder="Acquired Number">
									...
									<div class="form-group col-md-1">
										...
										<input type="text" class="form-control" id="eSafetyJobLG" placeholder="LG" disabled>
                                    ...
                                    <div class="form-group col-md-1">
                                        ...
                                        <input type="text" class="form-control" id="eSafetyJobGP" placeholder="GP" disabled>
							...
							<fieldset>
								...
								<div class="row">
									...
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control datepicker" name="issueDatejob" id="issueDatejob" placeholder="DD/MM/YYYY">
									</div>
								</div>
							</fieldset>
						...
						<form action="" method="post" enctype="multipart/form-data">
							<fieldset>
								...
								<div class="row">
									...
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control datepicker" id="dateOfExamination" name="dateOfExamination" placeholder="DD/MM/YYYY">
									</div>
							...
							<fieldset>
								...
								<div class="row">
									<div class="form-group col-md-4">
										...
										<input type="text" class="form-control" name="passportNo" id="passportNo" placeholder="Trainee Address">
									</div>
									<div class="form-group col-md-4">
							...
							<fieldset>
								...
								<div class="row">
									...
									<div class="form-group col-md-2">
										<input type="text" class="form-control result" name="theoretical" id="theoretical" placeholder="Acquired Point">
										<input type="text" class="form-control result" name="practical" id="practical" placeholder="Acquired Point">
										<input type="text" class="form-control result" name="generalFittings" id="generalFittings" placeholder="Acquired Point">
										<input type="text" class="form-control result" name="technicalArt" id="technicalArt" placeholder="Acquired Point">
										<input type="text" class="form-control result" name="basicEnglish" id="basicEnglish" placeholder="Acquired Point">
										<input type="text" class="form-control result" name="vivaVoce" id="vivaVoce" placeholder="Acquired Point">
									</div>
							...
							<fieldset>
								...
								<div class="row">
									...
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control datepicker" name="issueDate" id="issueDate" placeholder="DD/MM/YYYY">
									</div>
								</div>
							</fieldset>
        ...
        <script>
            $('.resultjob').change(function()
            {
                ...
                $('#'+id+'GP').val(GP);
                var total_GP=0;
                var eSafetyJobGP=parseFloat($('#eSafetyJobGP').val());
                ...
                if(etheoreticalJobGP!=NaN&&epracticalJobGP!=NaN&&emeasurementJobGP!=NaN&&edrawingJobGP!=NaN&&eSafetyJobGP!=NaN)
                {

                    //console.log(theoreticalGP);
                    total_GP=eSafetyJobGP+etheoreticalJobGP+epracticalJobGP+emeasurementJobGP+edrawingJobGP;
                    var total_final_GP=(total_GP/exam_basic);
                    total_final_GP=total_final_GP.toFixed(2);
                    if(total_final_GP<=100&&total_final_GP>=90)
                    {
                        var LG='A+';
                        var GP='Qualified';
                    }
                    else if(total_final_GP<=89&&total_final_GP>=80)
                    {
                        var LG='A';
                        var GP='Qualified';
                    }
                    else if(total_final_GP<=79&&total_final_GP>=70)
                    {
                        var LG='B+';
                        var GP='Qualified';
                    }
                    else if(total_final_GP<=69&&total_final_GP>=60)
                    {
                        var LG='B';
                        var GP='Qualified';
                    }
                    else if(total_final_GP<=59&&total_final_GP>=50)
                    {
                        var LG='C+';
                        var GP='Unfit';
                    }
                    else if(total_final_GP<=49&&total_final_GP>=40)
                    {
                        var LG='C';
                        var GP='Unfit';
                    }
                    else if(total_final_GP<=39&&total_final_GP>=0)
                    {
                        var LG='D';
                        var GP='Unfit';
                    }
